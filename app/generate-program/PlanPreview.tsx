...
export type Routine = { name: string; sets: number; reps: number; description?: string };
export type ExerciseDay = { day: string; routines: Routine[] };
export type WorkoutPlan = { schedule: string[]; exercises: ExerciseDay[] };
export type DietPlan = { dailyCalories: number; meals: { name: string; foods: string[] }[] };
      ...
      <div className="relative backdrop-blur-sm border border-border rounded-lg p-6">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-lg font-bold">
            PLAN: <span className="text-primary">{name}</span>
          </h3>
        </div>
        ...
        {tab === "workout" ? (
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {workoutPlan.exercises.map((exerciseDay, idx) => (
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="font-mono text-xl text-primary">{dietPlan.dailyCalories} KCAL</div>
            </div>
